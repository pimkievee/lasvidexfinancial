...
1. Add `https://veelegacy.ca/` as a property.
...
4. Submit `https://veelegacy.ca/sitemap.xml`.

## Bing Webmaster Tools

1. Add `https://veelegacy.ca/`.
...
1. Create a GA4 web data stream for `veelegacy.ca`.
...
2. Link the profile to `https://veelegacy.ca/`.
...
4. Add posts that link to the Resources hub and the Whitby landing page.
